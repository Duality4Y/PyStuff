...
while running:
    ...
    pygame.draw.rect(screen,white,GameObjects.obstacle1,1)
    
    pygame.draw.rect(screen,blue,(Player1.player()[0]-Player1.r,Player1.player()[1]-Player1.r,2*Player1.r,2*Player1.r),0);
    pygame.draw.circle(screen,green,Player1.player(),Player1.r,Player1.r/2);
