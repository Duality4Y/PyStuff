...
def processPlayers(enableControl):
    ...
    #    pygame.draw.circle(screen,player.colour,player.player(),player.r,0);
...
for p in range(number_of_players):
    ...
    speed = random.randint(4,80);
    accel = random.uniform(0.5,4);
...
my_players[0].accel = 0.01;
my_players[0].speed = 4;
